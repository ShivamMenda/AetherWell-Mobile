    ...
    return Scaffold(
      ...
      body: SingleChildScrollView(
        child: Padding(
          ...
          child: Obx(
              ()=>doctorAvailbilityController.isLoading.value?Center(child: CircularProgressIndicator()):Column(
              children: [
                SizedBox(height: 10),
                Text(
                  ...
                  child: GridView.count(
                    ...
                    children: [
                      CustomCardWidget(
                        icon: Icons.people,
                        header: 'Patients',
                        subheader: doctorAvailbilityController.patientNumbers.value,
                        iconColor: Colors.white70,
                      ),
                      CustomCardWidget(
                        icon: Icons.calendar_today,
                        header: 'Appointments',
                        subheader: doctorAvailbilityController.appointmentsNumber.value,
                        iconColor: Colors.white70,
                      ),
                    ],
                  ),
                ...
                Text(
                  "Confirmed vs Cancelled Appointments",
                  style: TextStyle(
                      color: Colors.white70,
                      fontWeight: FontWeight.bold,
                      fontSize: 20),
                ...
                Container(
                    child: SfCartesianChart(
                      ...
                      LineSeries<InflowData, String>(
                        name: 'Number of Patients', // Add series label
                    ...
                    Text("Day of the Month",style: TextStyle(color: Colors.white70,),),
              ],
            ),
          ),
        ),

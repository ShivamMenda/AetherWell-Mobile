...
class DoctorAvailbilityManagement extends StatefulWidget {
  ...
  @override
  State<DoctorAvailbilityManagement> createState() => _DoctorAvailbilityManagementState();
}

class _DoctorAvailbilityManagementState extends State<DoctorAvailbilityManagement> {
        ...
        child: Padding(
          ...
          child: Column(
            children: [
              ...
              SizedBox(height: 20),
              SizedBox(
                height: MediaQuery.of(context).size.height/4.5, // Set the height of the GridView
              ...
              SizedBox(height: 10,),
              Text("Patient Visit Satisfaction",style: TextStyle(color: Colors.white70,fontWeight: FontWeight.bold,fontSize: 24),),
              Container(

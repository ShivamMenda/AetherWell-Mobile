                ...
                child: Padding(
                  ...
                  child: Column(
                    children: [
                      ...
                      Text(
                        "Welcome, ${authController.doctor.name}!",
                        style: TextStyle(
                      ...
                      AppointmentDetailsCard(
                        dailyAppointments: doctorHomeController
                            .todaysAppointments
                            .value, // Replaced with your actual value from Api Calls
                        totalAppointments:
                      ...
                      SizedBox(height: 20),
                      //List View
                      doctorHomeController.todaysAppointmentList.length > 0
                          ? ListView.builder(
                              shrinkWrap: true,
                              physics: NeverScrollableScrollPhysics(),
                              itemCount: doctorHomeController
                                  .todaysAppointmentList.length,
                              itemBuilder: (BuildContext context, int index) {
                                Color? tileColor =
                                    Colors.blueAccent.withOpacity(0.05);

                                return AppointmentCard(
                                  appointmentDetails: doctorHomeController
                                      .todaysAppointmentList[index],
                                  tileColor: tileColor,
                                  patientName: doctorHomeController
                                      .todaysAppointmentListNames[index],
                                  onViewDetails: () {
                                    Navigator.push(
                                      context,
                                      MaterialPageRoute(
